...
export default function Model({ ...props }) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Object_21.geometry} material={nodes.Object_21.material} position={[30.22, 3.6, -2.3]} />
      <mesh geometry={nodes.Object_22.geometry} material={nodes.Object_22.material} position={[30.22, 3.6, 4.41]} />
      <mesh geometry={nodes.Object_23.geometry} material={nodes.Object_23.material} position={[30.22, 3.6, -9.59]} />
      <mesh geometry={nodes.Object_24.geometry} material={nodes.Object_24.material} position={[30.98, 3.6, -2.3]} />
      <mesh geometry={nodes.Object_25.geometry} material={nodes.Object_25.material} position={[30.98, 3.6, -9.59]} />
      <mesh
      ...
      />
      <mesh geometry={nodes.Object_42.geometry} material={materials['nft-anon1']} position={[-0.06, 4.17, -24.32]} />
      <mesh geometry={nodes.Object_8.geometry} material={nodes.Object_8.material} position={[30.98, 3.6, 4.41]} />
      <mesh geometry={nodes.floorWood.geometry} material={nodes.floorWood.material} />
      <mesh geometry={nodes.pergola001.geometry} material={materials['Physically Based']} />
      <mesh geometry={nodes.ltCovers001.geometry} material={nodes.ltCovers001.material} />
      <mesh geometry={nodes.ltCovers002.geometry} material={nodes.ltCovers002.material} />
      <mesh geometry={nodes.ltCovers003.geometry} material={nodes.ltCovers003.material} />
      <mesh geometry={nodes.ltCovers004.geometry} material={nodes.ltCovers004.material} />
      <mesh geometry={nodes.ltCovers005.geometry} material={nodes.ltCovers005.material} position={[0, 0, 2.31]} />
      <mesh geometry={nodes.ltCovers006.geometry} material={nodes.ltCovers006.material} />
      <mesh geometry={nodes.ltCovers007.geometry} material={nodes.ltCovers007.material} />
      <mesh geometry={nodes.ltCovers008.geometry} material={nodes.ltCovers008.material} />
      <mesh geometry={nodes.ltCovers009.geometry} material={nodes.ltCovers009.material} />
      <mesh geometry={nodes.ltCovers.geometry} material={nodes.ltCovers.material} position={[0, 0, 1.21]} />
      ...
      <group position={[0, 7.92, -20.36]} rotation={[0.63, -1.16, 0.01]}>
        <pointLight intensity={168.9} decay={2} rotation={[-Math.PI / 2, 0, 0]} />
      </group>
      <group position={[14.13, 6.11, -21.14]} rotation={[0.63, -1.16, 0.01]}>
        <pointLight intensity={141.9} decay={2} color="#fff0da" rotation={[-Math.PI / 2, 0, 0]} />
      </group>
      ...
      <group position={[36.43, 7.83, -20.44]} rotation={[0.63, -1.16, 0.01]}>
        <spotLight intensity={100} angle={Math.PI / 8} penumbra={0.15} decay={2} rotation={[-Math.PI / 2, 0, 0]} />
      </group>
      ...
      <group position={[0, 500, 0]}>
        <directionalLight intensity={0.9} decay={2} rotation={[-Math.PI / 2, 0, 0]} target={0, 0, 0}/>
      </group>
